 ...
 */
class Zend_View_Helper_ComputerCentersJson extends Zend_View_Helper_Abstract
{
    protected static $jsonArrayName = 'ComputerCenters';
    protected static $distanceFromPositionPrecision = 2;
    
    public static function computerCentersJson( $val, $timestamp = null ) {
    ...
    public static function create( Connect_ComputerCenter $center, $timestamp ) {
        ...
        if( !empty($timestamp) ) {
            $options['openNowString'] = 
                            Application_View_Helper_OpenNowString::openNowString( $center, $timestamp );
        }
