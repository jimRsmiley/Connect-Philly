...
class Subsite_Form_AddCenter extends Zend_Form 
{
    ...
    {   
        ...
        $this->addElementPrefixPath('Subsite_Form_Decorator_',
                            APPLICATION_PATH . '/modules/subsite/forms/decorators',
                            'decorator');
    } // end init()
    
    protected function getGeneralForm() {
        //$subForm = new Zend_Form_SubForm('general');
        $subForm = new Subsite_Form_ConnectSubform('general');
    ...
    protected function getMiscForm() {
        ...
        $subForm = new Subsite_Form_ConnectSubform();
    ...
    {
        $action = '/'.$this->_moduleName.'/'.$this->_controllerName.'/process';
